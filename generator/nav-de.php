                ...
                </li><li class="nav-item mx-2 dropdown"><a class="nav-link fw-bold dropdown-toggle {{ Request::is('metalltechnik-jobs') || Request::is('metalltechnik-jobs/*') ? 'active' : '' }}"
                        ...
                        <li>
                            <hr class="dropdown-divider my-0">
                                ...
                                <li><a class="dropdown-item {{ Request::is('metalltechnik-jobs/kauffrau-fuer-bueromanagement-stellenangebot-bad-teinach-nordschwarzwald/') ? 'active' : '' }}"
                                    href="/metalltechnik-jobs/kauffrau-fuer-bueromanagement-stellenangebot-bad-teinach-nordschwarzwald/">Kauffrau für Büromanagement</a></li></ul></li>
