...
@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="x-default" href="https://irion.de/en/certificates" />
<link rel="alternate" hreflang="de" href="https://irion.de/zertifikate" />
<link rel="alternate" hreflang="en" href="https://irion.de/en/certificates" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us/certificates" />
@endsection
...
<section class="container">
    ...
    <div id="certificates" class="row justify-content-center mt-5">
        <div class="card col-md-3 col-6 mb-5 animate__animated animate__fadeIn">
            <a class="btn btn-primary btn-lg rounded-0" target="_blank" href="{{ url('assets/certificates/DIN_EN_1090-2_EXC3-Zertifikat_2022-2025.pdf') }}">
                <i class="bi bi-eye"></i>
                <img src="{{ url('assets/certificates/DIN_EN_1090-2_EXC3-Zertifikat_2022-2025-cover.webp') }}" class="card-img-top cert-preview" alt="CNC Schweißen">
            </a>
        </div>
        @if (app()->getLocale() == "de")
        <div class="card col-md-3 col-6 mb-5 animate__animated animate__fadeIn">
            <a class="btn btn-primary btn-lg rounded-0" target="_blank" href="{{ url('assets/certificates/DIN_EN_ISO_3834-2_2021_Zertifikat_2022-2025.pdf') }}">
                <i class="bi bi-eye"></i>
                <img src="{{ url('assets/certificates/DIN_EN_ISO_3834-2_2021_Zertifikat_2022-2025-cover.webp') }}" class="card-img-top cert-preview" alt="CNC Schweißen">
            </a>
        </div>
        @else
        <div class="card col-md-3 col-6 mb-5 animate__animated animate__fadeIn">
        ...
        @if (app()->getLocale() == "de")
        <div class="card col-md-3 col-6 mb-5 animate__animated animate__fadeIn">
            <a class="btn btn-primary btn-lg rounded-0" target="_blank" href="{{ url('assets/certificates/ISO-9001-2015-Zertifikat-2019-2022_deutsch.pdf') }}">
                <i class="bi bi-eye"></i>
                <img src="{{ url('assets/certificates/ISO-9001-2015-Zertifikat-2019-2022_deutsch-cover.webp') }}" class="card-img-top" alt="CNC Schweißen">
            </a>
        </div>
        @else
        <div class="card col-md-3 col-6 mb-5 animate__animated animate__fadeIn">
