...
@section('title', trans_fb("welding-fabrications.welded-steel-constr.commercial-vehicle-bodies.title"))
...
@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="de" href="https://irion.de/schweisskonstruktionen/maschinenbau/fahrzeugaufbauten-hersteller" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us/welding-fabrications/welded-steel-construction/commercial-vehicle-bodies" />
@endsection
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ trans_fb("welding-fabrications.welded-steel-constr.commercial-vehicle-bodies.h1") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    {!! trans_fb("welding-fabrications.welded-steel-constr.commercial-vehicle-bodies.seo") !!}      
                </p>
            </div>
        </div>
    </div>
