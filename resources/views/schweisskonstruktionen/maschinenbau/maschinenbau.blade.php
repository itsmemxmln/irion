...
@section('title', __("Schweißkonstruktionen Maschinenbau – Stahlbaukonstruktionen"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Schweißkonstruktionen für den Maschinenbau") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion bietet hochwertige Schweißkonstruktionen für den Maschinenbau und Anlagenbau. <br><br>
                    Unsere Spezialitäten sind Scherenhubtische, Schweißgestelle, Grundrahmen oder Fahrzeugaufbauten und
                    Werkstückträgersysteme für die Industrie. Wir fertigen maßgeschneiderte Stahlbaukonstruktionen im
                    Projektgeschäft von 30 bis 5000 Stück in konstant hoher Qualität.
                </p>
