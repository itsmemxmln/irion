...
@section('title', __("Schweißgestelle – Stahlrahmenkonstruktionen Hersteller"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    ...
                    Irion ist ein Hersteller für hochwertige Schweißgestelle aus Stahl.
                    Unsere Stahlgestelle erfüllen die speziellen Anforderungen der Industrie und werden in der Logistik,
                    Instandhaltung und Produktion eingesetzt.
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte Stahlrahmenkonstruktionen von 30
