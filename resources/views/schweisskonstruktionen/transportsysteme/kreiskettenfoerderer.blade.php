...
@section('title', __("Kreiskettenförderer Komponenten – Teile Hersteller"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Kreiskettenförderer Komponenten – Mechanische Teile Hersteller") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    ...
                    Irion ist ein Hersteller für hochwertige Kreiskettenförderer Komponenten aus Stahl.
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte mechanische Teile für Kreisförderer
                    in der Intralogistik von 30 bis 5000 Stück. Wir stehen für konstant hohe Qualität,
