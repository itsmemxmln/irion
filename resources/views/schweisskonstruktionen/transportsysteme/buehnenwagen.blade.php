...
@section('title', __("Bühnenwagen – Fahrbare Hebebühnen Hersteller"))
...
@section('description','Bühnenwagen aus Stahl ✓ 30 bis 5000 Stück ☆ Konstant hohe Qualität ☆ Verantwortungsbewusst ☆
Präzise ➨ Fahrbare Hebebühnen Hersteller!')
@else
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion ist ein Hersteller für hochwertige Bühnenwagen aus Stahl.
                    Unsere Wagen erfüllen die speziellen Anforderungen der Industrie und werden in der Logistik,
                    Instandhaltung
                    und Produktion eingesetzt.
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte fahrbare Hebebühnen von 30 bis 5000
                    Stück.
                    Wir stehen für konstant hohe Qualität, Verantwortungsbewusstsein und Präzision.
                </p>
            </div>
        </div>
    </div>
