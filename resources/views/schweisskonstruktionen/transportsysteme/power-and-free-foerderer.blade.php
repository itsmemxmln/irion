...
@section('title', trans_fb("welding-fabrications.transp-syst.power-and-free-conveyors.title"))
...
@if (app()->getLocale() == "de")
    ...
    @section('description','Power and Free Förderer Komponenten ✓ 30 bis 5000 Stück ☆ Konstant hohe Qualität ☆
...
@elseif(app()->getLocale() == "en-US")
    ...
    @section('description','Power and Free conveyor components ✓ 30 to 5000 pieces ☆ Consistently high quality ☆ Precise ➨ Made in Germany since 1926!')
@else
    @section('keywords','irion, irion gmbh, Construction, Construction optimization, Calculation, CE documentation, FMEAMAG
    / MIG, CNC milling, Conventional cutting, Laser cutting, Flame cutting, Waterjet cutting, Bending / Edging, CNC turning,
    All proportions, 3-/4-/5-axis machining, WIG, Robotic applications, Weld inspection, Therm. / mech. straightening')
...
@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="de" href="https://irion.de/schweisskonstruktionen/transportsysteme-produktion/power-and-free-foerderer" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us/welding-fabrications/transportation-systems/power-and-free-conveyors" />
@endsection
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ trans_fb("welding-fabrications.transp-syst.power-and-free-conveyors.h1") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    {!! trans_fb("welding-fabrications.transp-syst.power-and-free-conveyors.seo") !!}
                </p>
            </div>
        </div>
    </div>
