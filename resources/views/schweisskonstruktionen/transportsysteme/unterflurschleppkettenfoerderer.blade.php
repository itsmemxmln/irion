...
@section('title', __("Unterflurschleppkettenförderer Komponenten – Hersteller"))
...
@section('description','Unterflurschleppkettenförderer Komponenten ✓ 30 bis 5000 Stk ☆ Konstant hohe Qualität ☆
Verantwortungsbewusst ☆ Präzise ➨ Mechanische Teile!')
@else
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Unterflurschleppkettenförderer Komponenten – Mechanische Teile Hersteller") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    ...
                    Irion ist ein Hersteller für hochwertige Unterflurschleppkettenförderer Komponenten aus Stahl.
                    <br><br>
