...
@section('title', __("Elektrohängebahn Komponenten – Mechanische Teile Hersteller"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Elektrohängebahn Komponenten – Mechanische Teile Hersteller") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion ist ein Hersteller für hochwertige Elektrohängebahn Komponenten aus Stahl.
                    <br><br>
