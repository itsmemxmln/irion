...
@section('title', __("Schwerlast Plattformwagen – Transportwagen Industrie"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Schwerlast Plattformwagen") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion ist ein Hersteller für hochwertige Schwerlast Plattformwagen aus Stahl.
                    Unsere Wagen erfüllen anspruchsvolle Anforderungen und werden in der Logistik, Instandhaltung und
                    Produktion eingesetzt.
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte Industrie Transportwagen von 30 bis
