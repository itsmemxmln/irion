...
@section('title', trans_fb("welding-fabrications.skid-construction.title"))
...
@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="de" href="https://irion.de/schweisskonstruktionen/skid-anlagenbau" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us/welding-fabrications/skid-construction" />
@endsection
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ trans_fb("welding-fabrications.skid-construction.h1") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    {{trans_fb("welding-fabrications.skid-construction.seo")}}
                </p>
                @if(app()->getLocale() == "de")
