...
@section('title', __("welding-fabrications.title"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">{{ __("welding-fabrications.h1") }}</h1>
</section>
