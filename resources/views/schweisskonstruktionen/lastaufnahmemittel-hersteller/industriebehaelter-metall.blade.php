...
@section('title', trans_fb("welding-fabrications.lifting-eq-ma.industrial-metal-bins.title"))
...
@elseif(app()->getLocale() == "en-US")
    ...
    @section('description','Industrial metal bins ✓ 30 to 5000 pieces ☆ Consistently high quality ☆ Precise ➨ Industrial containers from the manufacturer!')
@else
    @section('keywords','irion, irion gmbh, Construction, Construction optimization, Calculation, CE documentation, FMEAMAG
    / MIG, CNC milling, Conventional cutting, Laser cutting, Flame cutting, Waterjet cutting, Bending / Edging, CNC turning,
    All proportions, 3-/4-/5-axis machining, WIG, Robotic applications, Weld inspection, Therm. / mech. straightening')
...
@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="de" href="https://irion.de/schweisskonstruktionen/lastaufnahmemittel-hersteller/industriebehaelter-metall" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us/welding-fabrications/lifting-equipment-manufacturer/industrial-metal-bins" />
@endsection
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ trans_fb("welding-fabrications.lifting-eq-ma.industrial-metal-bins.h1") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    {!! trans_fb("welding-fabrications.lifting-eq-ma.industrial-metal-bins.seo") !!}
                </p>
            </div>
        </div>
    </div>
