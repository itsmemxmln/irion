...
@section('title', __("Schwerlasttraversen – Hebetechnik Hersteller"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion ist ein Hersteller für hochwertige Schwerlasttraversen aus Stahl.
                    Unsere Hebetechnik erfüllt die speziellen Anforderungen der Industrie und wird in der Logistik,
                    Instandhaltung und Produktion eingesetzt.
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte Traversen aus Stahl von 30 bis 5000
