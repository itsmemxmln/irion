...
@section('title', __("Transportbehälter Metall – Lagerbehälter Hersteller"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Transportbehälter aus Metall") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    ...
                    Irion ist ein Hersteller für hochwertige Transportbehälter aus Metall.
                    ...
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte Lagerbehälter aus Stahl von 30 bis
