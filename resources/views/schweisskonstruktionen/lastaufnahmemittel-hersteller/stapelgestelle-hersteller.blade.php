...
@section('title', __("welding-fabrications.lifting-eq-ma.metal-stacking-racks.title"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("welding-fabrications.lifting-eq-ma.metal-stacking-racks.h1") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    {!! __("welding-fabrications.lifting-eq-ma.metal-stacking-racks.seo") !!}
                </p>
            </div>
        </div>
    </div>
