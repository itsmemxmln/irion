...
@section('title', __("Stapelgestelle Hersteller – Stapelpaletten aus Metall"))
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ __("Stapelgestelle Hersteller") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion ist ein Hersteller für hochwertige Stapelgestelle aus Metall.
                    Unsere Fertigungstechnik erfüllt die speziellen Anforderungen der Industrie und wird in der
                    Logistik, Lagerhaltung und Produktion eingesetzt.
                    <br><br>
                    Unser zertifizierter Schweißfachbetrieb fertigt maßgeschneiderte Stapelpaletten aus Stahl von 30 bis
                    5000 Stück. Wir stehen für konstant hohe Qualität, Verantwortungsbewusstsein und Präzision.
                </p>
            </div>
        </div>
    </div>
