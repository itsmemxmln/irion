...
@section('title', trans_fb("welding-fabrications.conveyor-accessories-spare-parts.title"))
...
@if (app()->getLocale() == "de")
    ...
    @section('description','Fördertechnik Zubehör und Ersatzteile ✓ 30 bis 5000 Stück ☆ Konstant hohe Qualität ☆
...
@elseif(app()->getLocale() == "en-US")
    ...
    @section('description','Conveyor accessories and spare parts ✓ 30 to 5000 pieces ☆ Consistently high quality ☆ Precise ➨ Made in Germany since 1926!')
@else
    @section('keywords','irion, irion gmbh, Construction, Construction optimization, Calculation, CE documentation, FMEAMAG
    / MIG, CNC milling, Conventional cutting, Laser cutting, Flame cutting, Waterjet cutting, Bending / Edging, CNC turning,
    All proportions, 3-/4-/5-axis machining, WIG, Robotic applications, Weld inspection, Therm. / mech. straightening')
...
@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="de" href="https://irion.de/schweisskonstruktionen/foerdertechnik-zubehoer-ersatzteile" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us/welding-fabrications/conveyor-accessories-spare-parts" />
@endsection
...
<section class="page-banner"
    ...
    <h1 class="text-center text-white fw-bold animate__animated animate__zoomIn">
        {{ trans_fb("welding-fabrications.conveyor-accessories-spare-parts.h1") }}</h1>
</section>
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    {!! trans_fb("welding-fabrications.conveyor-accessories-spare-parts.seo") !!}
                </p>
            </div>
        </div>
    </div>
