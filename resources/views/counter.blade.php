<section class="irion-counter row text-white">
    <div class="col-md-3">
        <div class="counter-element">
            <div class="d-block text-center text-white">
                <p class="scroll-counter text-center" data-counter-time="2000" data-count="1000" data-presentation="1.000+">0</p>
    ...
    <div class="col-md-3">
        <div class="counter-element">
            <div class="d-block text-center text-white">
                <p class="scroll-counter" data-counter-time="2000" data-count="5000000" data-presentation="5.000.000">0</p>
    ...
    <div class="col-md-3">
        <div class="counter-element">
            <div class="d-block text-center text-white">
                <p class="scroll-counter" data-counter-time="2000" data-count="2000" data-presentation="2.000">0</p>
