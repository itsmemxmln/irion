...
@section('title', __("Edelstahl Zuschnitt nach Maß – Edelstahl lasern lassen"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion bietet einen hochwertigen Edelstahl Zuschnitt nach Maß.
                    <br><br>
                    Nicht nur beim Laserzuschnitt von Edelstahl gehen wir gerne auf Ihre individuellen Wünsche ein. Sie
                    können bei uns im Haus auch gleich schweißen, biegen, kanten und fräsen lassen.
                    <br><br>
                    ...
                    <br><br>
                    Bei Irion können Sie Edelstahl in großen Mengen lasern lassen. Wir arbeiten im Projektgeschäft ab
