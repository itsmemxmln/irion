...
@section('title', __("Schwarzblech Zuschnitt – Schwarzblech lasern lassen"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion bietet einen hochwertigen Schwarzblech Zuschnitt nach Maß.
                    <br><br>
                    Nicht nur beim Laserzuschnitt von Schwarzblechen gehen wir gerne auf Ihre individuellen Wünsche ein.
                    ...
                    <br><br>
                    Bei Irion können Sie Schwarzblech in großen Mengen lasern lassen. Wir arbeiten im Projektgeschäft ab
