...
@section('title', __("Werkzeugstahl Zuschnitt – Werkzeugstahl lasern lassen"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion bietet einen hochwertigen Werkzeugstahl Zuschnitt nach Maß.
                    <br><br>
                    Nicht nur beim Laserzuschnitt von Werkzeugstählen gehen wir gerne auf Ihre individuellen Wünsche
                    ein. Sie können bei uns im Haus auch gleich schweißen, biegen, kanten und fräsen lassen.
                    <br><br>
                    ...
                    <br><br>
                    Bei Irion können Sie Werkzeugstahl in großen Mengen lasern lassen. Wir arbeiten im Projektgeschäft
                    ab 100 bis 500.000 Stück. Die mögliche Dicke beträgt 1 mm bis 25 mm. Die maximale Größe der
