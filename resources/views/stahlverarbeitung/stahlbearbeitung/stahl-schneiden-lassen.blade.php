...
@section('title', __("Stahl schneiden lassen – Laserschneidbetrieb Deutschland"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion gibt es bereits seit 1926. Wir sind ein erfahrener Laserschneidbetrieb aus Deutschland,
                    genauer gesagt aus dem Schwarzwald. Unser Sitz ist Bad Teinach, das liegt in der Nähe von Städten
                    wie Stuttgart, Pforzheim und Tübingen.
                    <br><br>
                    Bei uns können Sie Stahl schneiden lassen ab 100 bis 500.000 Stück. Wir handeln
                    verantwortungsbewusst und legen wert auf präzises Arbeiten und konstant hohe Qualität!
                </p>
            </div>
        </div>
    </div>
