...
@section('title', __("Stahl biegen lassen – Biegebetrieb aus Deutschland"))
        ...
        <div class="row align-items-center rounded-0 border shadow-lg ">
            <div class="col-lg-12 p-5 center">
                <p style="text-align:center">
                    Irion gibt es bereits seit 1926. Wir sind ein erfahrener Biegebetrieb aus Deutschland, genauer
                    ...
                    <br><br>
                    Bei uns können Sie Stahl biegen lassen ab 100 bis 500.000 Stück. Wir handeln verantwortungsbewusst
