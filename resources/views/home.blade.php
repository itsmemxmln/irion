...
@if (app()->getLocale() == "de")
    @section('title', 'Schweißbaugruppen Hersteller – Irion Qualität seit 1926')
    @section('description','Schweißbaugruppen Hersteller ✓ 30 bis 5000 Stück ☆ Konstant hohe Qualität ☆ Verantwortungsbewusst ☆ Präzise ➨ Irion Qualität seit 1926!')
@elseif (app()->getLocale() == "en-US")
    @section('title', 'Welding fabrication shop – Irion quality since 1926')
...
@else
    @section('title','Industrial welding company – Irion quality since 1926')
    @section('description','Industrial welding company ✓ 30 to 5000 parts ☆ Consistently high quality ☆ Responsible-minded ☆ Precision ➨ Irion quality since 1926!')
@endif


@section('head')
<!-- Lang -->
<link rel="alternate" hreflang="x-default" href="https://irion.de/en" />
<link rel="alternate" hreflang="de" href="https://irion.de" />
<link rel="alternate" hreflang="en" href="https://irion.de/en" />
<link rel="alternate" hreflang="en-US" href="https://irion.de/us" />
@endsection
            ...
            <div class="carousel-item landing-carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-end animate__animated animate__fadeInRight">
                        <h1 class="h1 fw-bold" style="font-size: 1.9rem;">{{ __("Schweißbaugruppen Hersteller Irion") }}</h1>
                    </div>
                </div>
            </div>
        </div>
...
<section id="services" class="container my-5">
    <div class="col-md-9 mx-auto mb-5">
        ...
        <p class="text-center px-md-5">{{ __("Irion besteht seit 1926 und ist der Schweißbaugruppen Hersteller aus dem Schwarzwald. Unser zertifizierter Schweißfachbetrieb ist auf hochwertige Schweißbaugruppen von 30 bis 5000 Stück spezialisiert. Wir stehen für konstant hohe Qualität, Verantwortungsbewusstsein und Präzision.") }}</p>
    </div>
    <div class="mt-4">
